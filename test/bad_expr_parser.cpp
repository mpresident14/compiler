#include "test/bad_expr_parser.hpp"
    ...
    GrammarData GRAMMAR_DATA = {{{"INT","int",-2147483648},{"PLUS","",-2147483648},{"STAR","",-2147483648},},{{0},{1},{1},{1},},{{"S","Start"},{"Expr","Expr*"},}};struct StackObj {
      void* obj;
      int symbol;
    };
    struct SObj {
    ...
    void deleteObjPtr(const StackObj& s) {
      switch (s.symbol) {case -1: delete (int*) s.obj; break;case 1: delete (Expr**) s.obj; break;default: return;}}void deleteObj(const StackObj& s) {
      switch (s.symbol) {case -1: delete (int*) s.obj; break;case 1:delete *(Expr**) s.obj; delete (Expr**) s.obj; break;default: return;}}void* constructObj(int concrete, StackObj* args) {
      switch (concrete) {case 1: return new Expr*(new EInt(*(int*) args[0].obj));case 2: return new Expr*(new EPlus(*(Expr**) args[0].obj, *(Expr**) args[2].obj));case 3: return new Expr*(new ETimes(*(Expr**) args[0].obj, *(Expr**) args[2].obj));case 0: return new SObj((Expr**)args[0].obj);default: throw invalid_argument("Can't construct. Out of options.");}}StackObj construct(int concrete, StackObj* args, int varType) {
      return StackObj{ constructObj(concrete, args), varType };
    }StackObj constructTokenObj(int token, const string_view& str) {
      switch (token) {case -1:return { new int(stoi(string(str))), token };break;default: return {nullptr, token}; }}namespace lexer {struct Node {
...
auto n0x9a0d20=std::make_unique<Node>(-2147483648);
auto n0x9a0a30=std::make_unique<Node>(-2147483648);
auto n0x9a1050=std::make_unique<Node>(-1);
auto n0x9a1e10=std::make_unique<Node>(-2);
auto n0x9a1770=std::make_unique<Node>(-3);
auto makeDFA(){
n0x9a0d20->ts_={
{'~',n0x9a0a30.get()},
{'}',n0x9a0a30.get()},
...
return std::move(n0x9a0d20);
}
auto root=makeDFA();}enum class Assoc { LEFT, RIGHT, NOT, NONE };struct DFARule {
      int concrete;
      vector<int> symbols;
      size_t pos;
...
auto n0x9a5270=std::make_unique<Node>(RuleData{optional<DFARule>{},-2147483648,Assoc::NONE});
auto n0x9a3f00=std::make_unique<Node>(RuleData{optional<DFARule>{{1,{-1,},1,{0,1,1,}}},-2147483648,Assoc::NONE});
auto n0x99fc60=std::make_unique<Node>(RuleData{optional<DFARule>{{0,{1,},1,{0,0,0,}}},-2147483648,Assoc::NONE});
auto n0x9a3080=std::make_unique<Node>(RuleData{optional<DFARule>{},-2147483648,Assoc::NONE});
auto n0x9a4720=std::make_unique<Node>(RuleData{optional<DFARule>{},-2147483648,Assoc::NONE});
auto n0x9a2fb0=std::make_unique<Node>(RuleData{optional<DFARule>{{3,{1,-3,1,},3,{0,1,1,}}},-2147483648,Assoc::NONE});
auto n0x9a1a20=std::make_unique<Node>(RuleData{optional<DFARule>{{2,{1,-2,1,},3,{0,1,1,}}},-2147483648,Assoc::NONE});
auto makeDFA(){
n0x9a5270->ts_={
{-1,n0x9a3f00.get()},
{1,n0x99fc60.get()},
...
auto root=makeDFA();}
    ...
    } namespace test::bad_expr_parser{Expr*
