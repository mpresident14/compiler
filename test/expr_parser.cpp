#include "test/expr_parser.hpp"
    ...
    GrammarData GRAMMAR_DATA = {{{"INT","int",-2147483648},{"PLUS","",1},{"STAR","",2},},{{0},{1},{1},{1},},{{"S","Start"},{"Expr","Expr*"},}};struct StackObj {
      void* obj;
      int symbol;
    };
    struct SObj {
...
auto n0x9a1050=std::make_unique<Node>(-2147483648);
auto n0x9a1e10=std::make_unique<Node>(-2147483648);
auto n0x9a1770=std::make_unique<Node>(-1);
auto n0x9a0a30=std::make_unique<Node>(-2);
auto n0x9a0d20=std::make_unique<Node>(-3);
auto makeDFA(){
n0x9a1050->ts_={
{'~',n0x9a1e10.get()},
{'}',n0x9a1e10.get()},
...
auto n0x9a2fb0=std::make_unique<Node>(RuleData{optional<DFARule>{},-2147483648,Assoc::NONE});
auto n0x9a1a20=std::make_unique<Node>(RuleData{optional<DFARule>{{1,{-1,},1,{0,1,1,}}},-2147483648,Assoc::NONE});
auto n0x9a3080=std::make_unique<Node>(RuleData{optional<DFARule>{{0,{1,},1,{0,0,0,}}},-2147483648,Assoc::NONE});
auto n0x9a4720=std::make_unique<Node>(RuleData{optional<DFARule>{},-2147483648,Assoc::NONE});
auto n0x9a3f00=std::make_unique<Node>(RuleData{optional<DFARule>{},-2147483648,Assoc::NONE});
auto n0x99fc60=std::make_unique<Node>(RuleData{optional<DFARule>{{3,{1,-3,1,},3,{0,1,1,}}},2,Assoc::LEFT});
auto n0x9a5270=std::make_unique<Node>(RuleData{optional<DFARule>{{2,{1,-2,1,},3,{0,1,1,}}},1,Assoc::LEFT});
auto makeDFA(){
n0x9a2fb0->ts_={
{-1,n0x9a1a20.get()},
{1,n0x9a3080.get()},
...
auto root=makeDFA();}
    ...
    } namespace test::expr_parser{Expr*
