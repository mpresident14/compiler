...
void testNumStates(const DFA<DFARuleSet, int>& dfa) { TESTER.assertEquals(7, dfa.size()); }
...
void testInitState(const DFA<DFARuleSet, int>& dfa) {
  ...
  const DFARule expected2 = { EPLUS, { EXPR, PLUS, EXPR }, 0, { true, true, false } };
  const DFARule expected3 = { ETIMES, { EXPR, STAR, EXPR }, 0, { true, true, false } };
...
void testTransition(const DFA<DFARuleSet, int>& dfa) {
  ...
  const DFARule expectedExpr0 = { EPLUS, { EXPR, PLUS, EXPR }, 1, { true, true, false } };
  const DFARule expectedExpr1 = { ETIMES, { EXPR, STAR, EXPR }, 1, { true, true, false } };
