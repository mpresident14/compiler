...
template <typename T> inline void toCode(ostream &out, const vector<T> &v);
...
string parserCppCode(const string &parserFilePath, const string &namespaceName,
                     const string &addlCode, const GrammarData &grammarData) {
  stringstream out;
...
string lexerCppCode(const string &lexerFilePath, const string &namespaceName,
                    const string &addlCode, const GrammarData &grammarData) {
  stringstream out;
...
void generateParserCode(const string &parserFilePath,
                        const string &addlHdrIncludes, const string &addlCode,
                        const GrammarData &grammarData) {
  ...
  hppFile << parserHppCode(namespaceName, headerGuard, addlHdrIncludes,
                           grammarData);
  ...
  cppFile << parserCppCode(parserFilePath, namespaceName, addlCode,
                           grammarData);
}
